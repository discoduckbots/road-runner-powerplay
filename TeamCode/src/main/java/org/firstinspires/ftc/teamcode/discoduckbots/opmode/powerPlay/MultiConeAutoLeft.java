...
public class MultiConeAutoLeft extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        Trajectory trajectory1 = drive.trajectoryBuilder(new Pose2d())
                .lineToConstantHeading( new Vector2d(40.41, -3.06),
        ...
        Trajectory trajectory2 = drive.trajectoryBuilder(trajectory1.end())
                .lineToLinearHeading( new Pose2d(50.33, 23.74, Math.toRadians(93)),
                        SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2,
                                DriveConstants.MAX_ANG_VEL/2,
                                DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
        ...
        Trajectory trajectory3 = drive.trajectoryBuilder(trajectory2.end())
                .lineToConstantHeading( new Vector2d(48.34, -10.64),
                        SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2,
                                DriveConstants.MAX_ANG_VEL/2,
                                DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
        ...
        Trajectory trajectory4 = drive.trajectoryBuilder(trajectory3.end())
                .lineToConstantHeading( new Vector2d(50.33, 23.74),
                        SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL/2,
                                DriveConstants.MAX_ANG_VEL/2,
                                DriveConstants.TRACK_WIDTH),
                        SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL/2))
